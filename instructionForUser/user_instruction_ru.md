...
2. Чтение файла с набором колод из локальной директории:<br>
...
3. Удаление набора колод из приложения:<br>
![](resources/activity1/delete_chosen_deck_set.png)
   - Информация о наборе колод полностью стирается из памяти приложения.
4. Очистка списка ссылок, запомненных как "надежные":<br>
![](resources/activity1/clear_trusted_links_list.png)
   - Все ссылки, отмеченные пользователем как "надежные" (см. раздел "Безопасность ссылок") будут перепроверены.
5. Ссылки на инструкции к приложению и библиотеки, контактные данные владельца приложения.<br>
...
![](resources/activity1/progress_bar.png)<br>
    ...
    - Зеленая дуга — прогресс последнего прохождения колоды визуализированный;
    - Желтая дуга — лучший результат прохождения колоды визуализированный.
